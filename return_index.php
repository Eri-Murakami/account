        ...
        <form method="post"action="mail_confirm.php"method="post">
            ...
            <div>
                ...
                <select class="dropdown" name="address1">                    
                    ...
                    foreach ($address1 as $key => $address1){
                        if(!empty($clean['address1'])){
                            if($key === $clean['address1']){
                                echo'<option value"'.$key.'"selected>'.$address1.'</option>';
                            }else{
                                echo'<option value="'.$key.'">'.$address1.'</option>';
                            }
                        }else{
                            echo'<option value="'.$key.'">'.$address1.'</option>';
                        }
